...
with sync_playwright() as p:
    ...
    expect(page.locator('#media iframe')).to_have_attribute('src','https://www.youtube-nocookie.com/embed/'+next(k['video'] for k in knots if k['id']=='anchor-hitch')+'?autoplay=1&playsinline=1&rel=0')
